...
//        System.out.println("LazyFetchAspects => " + this.hashCode());
    ...
    @Pointcut("execution(public java.util.Collection<org.reactome.server.graph.curator.domain.model.DatabaseObject+>+ org.reactome.server.graph.domain.model.*.get*(..))" +
            "|| execution(public org.reactome.server.graph.curator.domain.model.DatabaseObject+ org.reactome.server.graph.domain.model.*.get*(..))")
