...
import org.reactome.server.graph.curator.domain.result.PersonAuthorReviewer;
import org.reactome.server.graph.curator.domain.result.SimpleEventProjection;
import org.reactome.server.graph.curator.repository.EventRepository;
import org.reactome.server.graph.curator.repository.PersonAuthorReviewerRepository;
import org.reactome.server.graph.curator.repository.PersonRepository;
import org.reactome.server.graph.curator.repository.PublicationRepository;
